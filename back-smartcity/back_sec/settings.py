"""
Django settings for back_sec project.
...
WSGI_APPLICATION = 'back_sec.wsgi.application'
...
#Gestion Image
MEDIA_ROOT= os.path.join(BASE_DIR,'ImagesFile')
MEDIA_URL= '/images/'
...
SIMPLE_JWT = {
    # "ACCESS_TOKEN_LIFETIME": timedelta(minutes=15),#utiliser en prod
